...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "Field Service Control Room"),
    React.createElement("p", null, "Dispatch truth, visit posture, technician actions, and spare-parts requests for field operations."),
    React.createElement(
      "p",
      null,
