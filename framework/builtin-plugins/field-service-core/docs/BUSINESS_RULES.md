# Field Service Core Business Rules

## Invariants

- The plugin remains authoritative only for the data declared in `field-service-core` and its owned resource set.
...
- ERP parity references are tracked against: `Support`, `Maintenance`, `Projects`.
