...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/field-service-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-field-service-core:");
...
console.log("Documentation check passed for gutu-plugin-field-service-core.");
